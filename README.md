...
| _Pick or enter a room number, preview your camera, and copy invite links._ |  _Check your mic and webcam before stepping into the call._  |
...
| _Active speaker glow, floating control bar, local recording, and room lock._ | _Direct encrypted chat, emoji reactions, and live collaborative agenda notes._ |

### Host & Admin Dashboard

![Admin Dashboard](docs/screenshots/03-admin-dashboard.png)
_Manage active rooms, change permissions on the fly, lock rooms, or send announcements across the network._
